...
class ReceivableTests(TestCase):
    def setUp(self):
        self.company = billing.models.Company.objects.get_or_create(
            **billing_base_data['Company'])[0]
        self.bill = billing.models.Bill.objects.get_or_create(
            company=self.company,
            **billing_base_data['Bill'])[0]
        self.payment_method = billing.models.FormaPago.objects.get_or_create(
            codigo="33",
            descripcion="Efectivo")[0]
